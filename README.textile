...
* "Property Graph Model":http://blueprints.tinkerpop.com: a collection of single-step traversals can be composed to yield complex graph traversals. Process with the following graph systems:
