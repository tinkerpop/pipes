...
public class Pipeline<S, E> implements Pipe<S, E> {
    ...
    /**
     * Onle use if the intermediate pipes of the pipeline have been chained together manually.
     *
    ...
    /**
     * Clear the pipeline by clearing the start and end pipes.
     */
    public void clear() {
        this.endPipe.clear();
        this.startPipe.clear();
    }
}
