...
public class AggregatorPipeTest extends TestCase {
    ...
    // TODO: get AND and OR workings!
    /*public void testSelfFilter() {
        List<String> list = Arrays.asList("marko", "antonio", "rodriguez", "was", "here", ".");
        AggregatorPipe<String> pipe1 = new AggregatorPipe<String>(new ArrayList<String>());
        Pipe pipe2 = new ObjectFilterPipe<String>(pipe1.getSideEffect(), ComparisonFilterPipe.Filter.EQUALS);
        ...
        pipe2 = new ObjectFilterPipe<String>(pipe1.getSideEffect(), ComparisonFilterPipe.Filter.NOT_EQUALS);
